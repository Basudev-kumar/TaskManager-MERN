        ...
        {task && (
          ...
          <div className="form-card col-span-3">
            ...
            <div className="grid grid-cols-12 gap-4 mt-4">
              ...
              <div className="col-span-6 md:col-span-4">
                <InfoBox 
              label="dueDate" value={task?.dueDate?moment(task?.dueDate).format("Do MMM YYYY"):"N/A"}
              />
              </div>
              <div className="col-span-6 md:col-span-4">
...
const TodoCheckList= ({onChange,text,isChecked})=>{
  ...
  return <div className="flex items-center gap-3 p-3">
    ...
    checked={isChecked}
    onChange={onChange}
    className='w-4 h-4 accent-blue-600 bg-gray-100 border-gray-300 rounded-sm outline-none cursor-pointer '
    />
...
//   return <a href={link} 
//   target="_blank" 
//   rel="noopener noreferrer" className="flex justify-between bg-gray-50 border border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer"
//   onClick={onClick}>
//     <div className="flex-1 flex items-center gap-3">
//       <span className="text-xs text-gray-400 font-semibold mr-2">
//         {index < 9 ? `0${index+1}` : index+1}
