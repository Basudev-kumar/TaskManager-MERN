...
const createTask = async (req, res) => {
  try {
    const {
      ...
      assignedTo,
      attachments,
      todoChecklist, // corrected typo from todoCheckIist
    } = req.body;
    ...
    const task = await Task.create({
      ...
      todoChecklist, // corrected typo from todoChecktist
      attachments,
    });
...
const getUserDashboardData = async (req, res) => {
  try {
    ...
    const userId = new mongoose.Types.ObjectId(req.user.id);    //although it's depricated
